...
def default_scenarios() -> list[Scenario]:
    return [
        Scenario(name="a: alpha=0, beta=2", alpha=0.0, beta=2.0),
        Scenario(name="b: alpha=0.1, beta=0", alpha=0.1, beta=0.0),
        Scenario(name="c: alpha=0.1, beta=2", alpha=0.1, beta=2.0),
    ]
