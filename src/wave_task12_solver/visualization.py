...
from .solver import WaveTask12Result


def plot_results(config: WaveTask12Config, result: WaveTask12Result, show: bool = True) -> None:
    x = result.x_grid
    t = result.t_grid
    ...
    ax1.set_title("Задача 12: численное решение в разные моменты времени")
    ax1.set_xlabel("x")
